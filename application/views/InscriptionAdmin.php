...
<body>
  ...
  <div class="form_container">
    ...
    <form name="sign_in" class="Inscription" style="width:30%;" action="<?=site_url('InscriptionAdmin/create_account')?>" method="post" id="form">
      <h1>Inscription</h1>
      <p>
          Votre identifiant :<br />
          <input type="text" name="login" id="firstname" placeholder="First name" required/>
      </p>
      <p>
